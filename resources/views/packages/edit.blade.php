        ...
        <div class="pt-5">                                   
            ...
            <div class="panel">
                ...
                <div class="grid grid-cols-1 gap-4 mb-4 md:grid-cols-4">
                    ...
                    <x-text-input name="validity_in_days" value="{{ old('validity_in_days', $package->validity_in_days) }}" :label="__('Validity (in Days)')" :messages="$errors->get('validity_in_days')" :require="true"/>
                    <x-combo-input name="cost" value="{{ old('cost', $package->cost) }}" :label="__('Cost')" :messages="$errors->get('cost')" :require="true"/>                    
                </div> 
