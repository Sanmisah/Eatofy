        ...
        <form class="space-y-5" action="{{ route('suppliers.store') }}" method="POST">
            ...
            <div class="panel">
                ...
                <div class="grid grid-cols-1 gap-4 mb-4 md:grid-cols-4"> 
                    ...
                    <x-text-input name="supplier_contact_no" value="{{ old('supplier_contact_no') }}" :label="__('Supplier Contact No')" :messages="$errors->get('supplier_contact_no')"/>  
                    <x-text-input name="gstin" value="{{ old('gstin') }}" :label="__('GSTIN')" :messages="$errors->get('gstin')" /> 
                </div>               
                <div class="grid grid-cols-1 gap-4 mb-4 md:grid-cols-1"> 
                    <x-text-input name="address_line_1" value="{{ old('address_line_1') }}" :label="__('Address Line 1')" :messages="$errors->get('address_line_1')"/>
                </div>
                <div class="grid grid-cols-1 gap-4 mb-4 md:grid-cols-1"> 
                    <x-text-input name="address_line_2" value="{{ old('address_line_2') }}" :label="__('Address Line 2')" :messages="$errors->get('address_line_2')"/>
                </div>
                <div class="grid grid-cols-1 gap-4 mb-4 md:grid-cols-4">                     
                    <div>
                        <label>State:</label>
                    ...
                    <x-text-input name="pincode" value="{{ old('pincode') }}" :label="__('Pincode')" :messages="$errors->get('pincode')" />
                </div>
